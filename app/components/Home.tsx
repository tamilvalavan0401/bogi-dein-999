      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex flex-col md:flex-row gap-6 pt-4 pb-6 ">
          <div className="flex-1">
            <div className="mb-1">
              <span className="text-[32px]  text-primary font-[900] mr-4">Bogi Dein</span>{" "}
              <span className="text-[20px] font-600 text-[#000000]">Baby & Women Care</span>
            </div>
            {/* <p className="text-[16px] text-[#707070] mb-2">
                Founder: {"{Customer Name}"}
              </p> */}
            <p className="text-[16px] text-[#2D2D2D] leading-relaxed mb-4 ">
              We’re a trusted online destination for premium, safe, and thoughtfully selected baby and kids essentials that <br className="hidden md:block" />  bring peace of mind to parents. Every product is handpicked for quality, safety, and everyday joy .
            </p>
          ...
          <div className=" flex flex-col gap-3">
            ...
            <div className="rounded-lg p-[16px] text-sm space-y-2 bg-addresscard ">
              <div className="flex items-start gap-2">
                ...
                <p className="text-[#000000] text-[14px] font-medium leading-relaxed font-segoeui">
                  C1 G1 Sudarsan silver dale apartments, <br /> Surya Avenue 1st street, Near Palavaram taluk office,<br />
                  Chrompet Chennai 45
              ...
              <div className="flex items-center gap-2">
                <SvgIcons.Mail/>
                <a href="mailto:info@bogilife.in" className="text-[#000000] text-[14px] font-medium leading-relaxed  font-segoeui">
                  info@bogilife.in
                </a>
              </div>
              <div className="flex items-center gap-2">
                <SvgIcons.Call/>
                <a href="tel:+918807742710" className="text-[#000000] text-[14px] font-medium leading-relaxed  font-segoeui">
                  +91 88077 42710
                </a>
              </div>
            </div>
  ...
  return (
    <section className="bg-white py-8 w-full">
      <div className="max-w-6xl mx-auto px-4 md:px-8 text-center">
        <h2 className="text-xl md:text-[32px] text-gray-900 mb-6  font-[900] lato-regular">
...
function ProductsSection({
  ...
  return (
    <section id="products" className=" w-full bg-[#F8F9FC] py-[100px]">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <h2 className="text-2xl md:text-[42px] font-[800] lato-regular text-gray-900 text-center   mb-[24px]">
          Our Products 
        </h2>
...
function ContactSection({
  ...
  const DEFAULT_STORE_NAME = "info@bogilife.in";
  ...
  return (
    <section id="contact" className="bg-white py-12 w-full">
      <div className="max-w-lg mx-auto px-6">
        <h2 className="text-2xl md:text-[42px] font-[800] tracking-wide lato-regular text-gray-900 text-center mb-8  ">
          Let&apos;s Talk Business
        </h2>
...
export default function HomeMain() {
  ...
  const handleShare = useCallback(async () => {
    const shareData = {
      ...
      text: "Bogi Dein Toy Shop | Fun & Learning Toys for Kids",
